...
class TransformControlsGizmo extends Object3D {
    ...
    constructor() {
        ...
        function CircleGeometry(radius, arc) {
            ...
            const geometry = new TorusGeometry(radius, 0.0075, 3, 64, arc * Math.PI / 2 * 2);
        ...
        const gizmoCombined = {
            X: [
                [new Mesh(arrowGeometry, matRed), [0.5, 0, 0], [0, 0, - Math.PI / 2]],
                [new Mesh(CircleGeometry(0.5, 0.5), matRed), null, [0, Math.PI / 2, Math.PI / 2]],
            ],
            Y: [
                [new Mesh(arrowGeometry, matGreen), [0, 0.5, 0]],
        ...
        const pickerCombined = {
            ...
            XR: [[new Mesh(new TorusGeometry(0.5, 0.05, 4, 24,
                -Math.PI / 2 + Math.PI), matRedTransparent), [0, 0, 0], [Math.PI / 2, 0, 0]]],
            YT: [
